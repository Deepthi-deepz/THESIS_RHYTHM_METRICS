...
from thesis_rhythm.features.varco import load_alignments, extract_utterance_varco_metrics
...
from thesis_rhythm.trials.varco_trials import build_side_vector, build_structures, build_trials
...
def run_experiment(config_path: str) -> None:
    ...
    metrics_df = extract_utterance_varco_metrics(df, vowels=vowels)
...
def main():
    parser = argparse.ArgumentParser(description="Compute Varco rho2 tables on train-clean-100.")
