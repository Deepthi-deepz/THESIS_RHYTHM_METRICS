...
def save_summary(tables: dict[str, pd.DataFrame], dataset_name: str, output_dir: Path) -> None:
    rows = []
...
def run_experiment(config_path: str) -> None:
    ...
    save_summary(tables, dataset_name=dataset_name, output_dir=output_dir)
    print(f"\nDone. Final tables written to: {output_dir}")


def main():
    parser = argparse.ArgumentParser(description="Run anonymization rhythm comparison with rho2.")
